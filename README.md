...
Provides a way to synchronize outdated indexes with the source quickly and without doing a full reset. By default field `updated_at` but this could be defined by `outdated_sync_field` as described at [Chewy::Type::Syncer](lib/chewy/type/syncer.rb).
